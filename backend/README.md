...
## Project Structure
    ...
    ├── testapiautoconnect_124277  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_124277`
...
2. Clone this repo and `cd testapiautoconnect_124277`
